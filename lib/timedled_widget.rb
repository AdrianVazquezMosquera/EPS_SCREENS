...
module Cosmos
  ...
  class TimedledWidget < Qt::Label
    ...
    def initialize(parent_layout, target_name, packet_name, item_name, time_item_name = 'PACKET_TIMESECONDS', value_type = :CONVERTED, width = 15, height = 15)
